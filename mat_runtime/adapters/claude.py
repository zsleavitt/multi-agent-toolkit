...
class ClaudeAdapter(CLIAdapter):
    ...
    Invokes `claude` CLI with appropriate flags for non-interactive execution.
    """
    ...
    def invoke(
        ...
        **kwargs: Any,
        ...
        For long system prompts, writes to a temp file and uses --system-prompt flag.
        """
        # If system prompt is long, use a file
